...
export default function homebanner () {
    return (
        <Carousel>
            ...
            <Carousel.Item>
                <Container fluid className="homebanner">
                    <Image src={'/img/homebanner-13.jpeg'} width={500} height={700} alt="Home Banner"></Image>
                    <div className="centerbox w-100">
                        <p style={{fontWeight:'bold'}}>COVID-19 RESPONSE UPDATES</p>
                        <div className="numcounterarea">
                    ...
                    <Image src={'/img/homebanner-33.jpeg'} width={500} height={700} alt="Home Banner"></Image>
                </Container>
            </Carousel.Item>
            <Carousel.Item>
                <Container fluid className="homebanner">
                    <Image src={'/img/homebanner-14.jpeg'} width={500} height={700} alt="Home Banner"></Image>
                    <div className="centerbox w-100">
                        <p style={{fontWeight:'bold'}}>COVID-19 RESPONSE UPDATES</p>
                        <div className="numcounterarea">
                    ...
                    <Image src={'/img/homebanner-44.jpeg'} width={500} height={700} alt="Home Banner"></Image>
                </Container>
            </Carousel.Item>
        </Carousel>
    );
